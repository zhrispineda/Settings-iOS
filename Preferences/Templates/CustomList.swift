...
let defaultPaddingViews = ["Accessibility", "Always Allowed", "App Clips", "App Installations & Purchases", "Apple Advertising", "AppleCare & Warranty", "Automatic Updates", "Communication Safety", "Content Restrictions", "Developer", "Dictation Shortcut", "Display", "Game Center", "Headphone Audio Levels", "Health", "Language & Region", "Maps", "News", "Notifications", "Photos", "Safari", "Siri Voice", "Sources", "Spoken Responses", "TV Provider", "Web Content", "WebKit Feature Flags"]
