...
let defaultPaddingViews = ["Accessibility", "App Installations & Purchases", "Content Restrictions", "Developer", "Game Center", "Health", "Language & Region", "Maps", "News", "Photos", "Safari", "Siri & Search", "Web Content"]
