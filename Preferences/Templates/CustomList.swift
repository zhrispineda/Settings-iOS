...
let defaultPaddingViews = ["Content Restrictions", "App Installations & Purchases", "Language & Region", "Accessibility", "Safari", "News", "Maps", "Health", "Siri & Search", "Photos", "Game Center", "Developer"]
