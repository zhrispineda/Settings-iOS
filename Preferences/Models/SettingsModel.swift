...
@MainActor let mainSettings: [SettingsItem] = [
    ...
    SettingsItem(type: .actionButton, title: "Action Button", icon: "iphone.action.button.arrow.right", capability: .actionButton, color: .blue, destination: AnyView(BundleControllerView("ActionButtonSettings", controller: "ActionButtonSettings"))),
    ...
    SettingsItem(type: .multitaskGestures, title: "Multitasking & Gestures", icon: "squares.leading.rectangle", color: .blue, destination: AnyView(BundleControllerView("MultitaskingAndGesturesSettings", controller: "MultitaskingAndGesturesSettings", title: "Multitasking & Gestures"))),
