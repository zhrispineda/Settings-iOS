    ...
    var body: some View {
        CustomList(title: "EMERGENCY_SOS".localize(table: "SOS")) {
            Section {
                ...
                Text("PHONE_TRIGGER_ANIMATION_VOLUME_LOCK_HOLD_FOOTER_REQUIRE_SIM".localize(table: "SOS"))
            }
            
            Section {
                Toggle("CALL_WITH_HOLD_AND_RELEASE".localize(table: "SOS"), isOn: $callHoldRelease.animation())
            } footer: {
                Text("CALL_WITH_HOLD_FOOTER".localize(table: "SOS"))
            }
            
            Section {
                Toggle("CALL_WITH_FIVE_PRESSES".localize(table: "SOS"), isOn: $callButtonPresses)
            } footer: {
                Text("CALL_WITH_FIVE_PRESSES_FOOTER".localize(table: "SOS"))
            }
            ...
            if callHoldRelease {
                Section {
                    ...
                    Text("ALARM_SOUND_RELEASE_TO_CALL_FIVE_PRESSES_FOOTER".localize(table: "SOS"))
                }
            }
