...
struct DownloadsView: View {
    var body: some View {
        CustomList(title: "Downloads") {
            ...
            Section {
                CustomNavigationLink(title: "Remove Download List Items", status: "After one day", destination: AllowDenySelection(title: "Remove Download List Items", options: ["After one day", "Upon successful download", "Manually"], selected: "After one day"))
            }
        }
    }
}
