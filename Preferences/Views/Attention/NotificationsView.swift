        ...
        CustomList(title: "TITLE".localize(table: table), topPadding: true) {
            ...
            Section {
                ...
                if UIDevice.IntelligenceCapability {
                    CustomNavigationLink(title: "SUMMARIZE_NOTIFICATIONS".localize(table: table), status: "OFF".localize(table: table), destination: SummarizeNotificationsView())
                }
            }
            
            // MARK: Siri Section
            Section {
                CustomNavigationLink(title: "SPOKEN_NOTIFICATIONS".localize(table: table), status: "OFF".localize(table: table), destination: AnnounceNotificationsView())
