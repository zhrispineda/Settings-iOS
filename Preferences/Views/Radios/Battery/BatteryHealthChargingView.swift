    ...
    var body: some View {
        CustomList(title: "Battery Health & Charging") {
            ...
            Section {
                ...
                Text("Built-in dynamic software and hardware systems will help counter performance impacts that may be noticed as your \(DeviceInfo().model) battery chemically ages.")
            }
            ...
            Section {
                ...
                Text("To reduce battery aging, \(DeviceInfo().model) learns from your daily charging routines so it can wait to finish charging past 80% until you need to use it. \(temporaryOptimizePauseEnabled ? "Optimized Battery Charging is off until 6:00 AM. " : "")")
            }
