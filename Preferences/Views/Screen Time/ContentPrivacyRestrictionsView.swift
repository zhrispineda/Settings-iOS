    ...
    var body: some View {
        CustomList(title: "Content & Privacy Restrictions") {
            ...
            Section(content: {
                ...
                CustomNavigationLink(title: "Share My Location", status: "Allow", destination: AllowDenySelection(title: "Share My Location"))
                ...
                CustomNavigationLink(title: "Apple Advertising", status: "Allow", destination: AllowDenySelection(title: "Apple Advertising"))
