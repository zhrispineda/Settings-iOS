...
struct DownloadsView: View {
    var body: some View {
        CustomList(title: "Downloads") {
            ...
            Section {
                SettingsLink("Remove Download List Items", status: "After one day", destination: SelectOptionList("Remove Download List Items", options: ["After one day", "Upon successful download", "Manually"], selected: "After one day"))
            }
        }
    }
}
