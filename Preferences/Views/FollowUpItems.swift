    ...
    var body: some View {
        Section {
            HStack {
                Image(
                    "iphone",
                    bundle: Bundle(path: "\(UIDevice.RuntimePath)/System/Library/PrivateFrameworks/MobileBackup.framework/PlugIns/MBPrebuddyFollowUpExtension.appex")
                )
                .resizable()
    ...
    var body: some View {
        Section {
            Label {
                ...
                Image(
                    "iphone",
                    bundle: Bundle(path: "\(UIDevice.RuntimePath)/System/Library/PrivateFrameworks/Disembark.framework")
                )
            }
